<template>
    ...
    <!-- <canvas id="templine" width=1000 height=1000 style="{width: 1000px; height: 1000px}"></canvas> -->
</template>
...
export default{
    ...
    methods:{
        ...
        drawHighlight(){
            ...
            // let canvas = document.querySelector("#templine");
            // let context = canvas.getContext('2d');
            // context.fillStyle = '#ffffff'
            // context.fillRect(0, 0, 1000, 1000)   

            // x_min_domain = data_field["min_domain"][1];
            // y_max_domain = data_field["max_domain"][this.data_type];
            // x_range_to_draw = LINECHART_WIDTH/(data_field["max_domain"][1]-data_field["min_domain"][1]);
            // y_range_to_draw = LINECHART_HEIGHT/(data_field["max_domain"][this.data_type] - data_field["min_domain"][this.data_type]);
            ...
            //     let x_to_draw = (getDataTime(begin_idx)-x_min_domain)*x_range_to_draw;
            //     let y_to_draw = (y_max_domain-getDataValue(begin_idx, this.data_type))*y_range_to_draw;
            //     context.moveTo(x_to_draw, y_to_draw);
            //     for(let j=begin_idx+1; j<end_idx;j++){
            //         x_to_draw = (getDataTime(j)-x_min_domain)*x_range_to_draw;
            //         y_to_draw = (y_max_domain-getDataValue(j, this.data_type))*y_range_to_draw;
            //         context.lineTo(x_to_draw, y_to_draw);
            //     }
                
            //     context.strokeStyle = color_for_highlight[interactive_list[i]][0];
            //     context.stroke();
            //     context.closePath();
            // }
            ...
            //             let x_to_draw = (getDataTime(idx)-x_min_domain)*x_range_to_draw;
            //             let y_to_draw = (y_max_domain-getDataValue(idx, this.data_type))*y_range_to_draw;
            //             context.fillStyle = color_for_highlight[interactive_list[i]][0];
            //             context.strokeStyle = color_for_highlight[interactive_list[i]][0];
            //             if(circle_type === 0){
            //                 context.arc(x_to_draw, y_to_draw, 3, 0, 2*Math.PI);
            //             }
            //             else if(circle_type === 1){
            //                 context.fillRect(x_to_draw-3, y_to_draw-3, 6, 6);
            //             }
            //             else if(circle_type === 2){
            //                 context.moveTo(x_to_draw-3, y_to_draw);
            //                 context.lineTo(x_to_draw, y_to_draw-3);
            //                 context.lineTo(x_to_draw+3, y_to_draw);
            //                 context.lineTo(x_to_draw, y_to_draw+3);
            //             }
            //             context.closePath();
            //             context.fill();
